...
DEFINES="-DRAPI_GL=1 -DWAPI_SDL3=1 -DAAPI_SDL3=1 -DCAPI_SDL3=1 -DHAVE_SDL3=1 -DVERSION_US -D_LANGUAGE_C -DNIGHTLY -DNON_MATCHING -DAVOID_UB -DF3DEX_GBI_2E -DDISCORD_SDK"
