...
#endif
#define LOG_CONSOLE(...)  { snprintf(gMxuiConsoleTmpBuffer, MXUI_CONSOLE_MAX_TMP_BUFFER, __VA_ARGS__), mxui_console_message_create(gMxuiConsoleTmpBuffer, MXUI_CONSOLE_MESSAGE_INFO); }
