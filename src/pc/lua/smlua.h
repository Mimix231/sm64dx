...
#define LOG_LUA(...)  { if (!gSmLuaSuppressErrors) { printf("[LUA] "), printf(__VA_ARGS__), printf("\n"), smlua_mod_error(), snprintf(gMxuiConsoleTmpBuffer, MXUI_CONSOLE_MAX_TMP_BUFFER, __VA_ARGS__), sys_swap_backslashes(gMxuiConsoleTmpBuffer), mxui_console_message_create(gMxuiConsoleTmpBuffer, MXUI_CONSOLE_MESSAGE_ERROR); } }
#define LOG_LUA_LINE(...)  { if (!gSmLuaSuppressErrors) { printf("[LUA] "), printf(__VA_ARGS__), printf("\n"), smlua_mod_error(); snprintf(gMxuiConsoleTmpBuffer, MXUI_CONSOLE_MAX_TMP_BUFFER, __VA_ARGS__), sys_swap_backslashes(gMxuiConsoleTmpBuffer), mxui_console_message_create(gMxuiConsoleTmpBuffer, MXUI_CONSOLE_MESSAGE_ERROR), smlua_logline(); } }
#define LOG_LUA_LINE_WARNING(...)  { if (!gLuaActiveMod->showedScriptWarning) { gLuaActiveMod->showedScriptWarning = true; smlua_mod_warning(); snprintf(gMxuiConsoleTmpBuffer, MXUI_CONSOLE_MAX_TMP_BUFFER, __VA_ARGS__), sys_swap_backslashes(gMxuiConsoleTmpBuffer), mxui_console_message_create(gMxuiConsoleTmpBuffer, MXUI_CONSOLE_MESSAGE_WARNING); } }
